Webruntime.moduleRegistry.define('c/testgeneralsupportticket', ['lwc', 'lightning/configProvider', 'webruntime/configProvider', 'aura'], function (lwc, configProvider, configProvider$1, aura) { 'use strict';

    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".slds-button" + shadowSelector + "{font-size: 1rem;border-radius: 10px;}\n.slds-text-heading--label" + shadowSelector + "{font-size: 20px;text-align: center;margin: 30px;}\n.slds-m-around_medium" + shadowSelector + "{width: 160px;height: 160px;text-align: center;display: inline-block;}\n.slds-form-element__label" + shadowSelector + "{margin: 1px;}\n.slds-m-left_x-lager" + shadowSelector + "{width: 100px;height: 100px;}\n.slds-button" + shadowSelector + "{font-size: 12px;}\n";
    }
    ...
    **/
    ...
    var card = lwc.registerTemplate(tmpl$5);
    tmpl$5.stylesheets = [];
    ...
    var inline = lwc.registerTemplate(tmpl$6);
    tmpl$6.stylesheets = [];
    ...
    var _tmpl$6 = lwc.registerTemplate(tmpl$7);
    tmpl$7.stylesheets = [];
    ...
    **/
    ...
    function tmpl$9($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        classMap: {
          ...
          "slds-m-bottom--small": true
        },
        key: 3
      }, [api_text("Ask Accounting Ticket")]), api_text("RecordId: "), api_dynamic($cmp.currentRecordId), api_element("div", {
        classMap: {
        ...
        props: {
          "name": "tickettype",
          "value": $cmp.tickettypevalue,
          "label": "Please choose a ticket type:",
          "placeholder": "None",
          "options": $cmp.tickettypeoptions
        },
        key: 7,
        on: {
          "change": _m0 || ($ctx._m0 = api_bind($cmp.tickettypedropdownHandler))
        }
      }, []), api_element("br", {
        key: 8
      }, []), api_element("div", {
        ...
        key: 10,
        on: {
          "click": _m1 || ($ctx._m1 = api_bind($cmp.nextHandler))
        }
      }, [api_text("Next")])])])])];
    }
    ...
    tmpl$9.stylesheetTokens = {
      hostAttribute: "lwc-testgeneralsupportticket_testgeneralsupportticket-host",
      shadowAttribute: "lwc-testgeneralsupportticket_testgeneralsupportticket"
    };

    var AAT_LOGO = `${configProvider$1.getBasePath()}/assets/4caa124b99/AskAcctLogoSR`;

    function stylesheet$4(hostSelector, shadowSelector, nativeShadow) {
      return ".slds-text-heading_small" + shadowSelector + "{font-style: italic;color: grey;float: left;}\n.slds-text-heading--label" + shadowSelector + "{font-size: 20px;text-align: center;margin: 30px;}\n.slds-form" + shadowSelector + "{height:300px;}\n.slds-form-element__label" + shadowSelector + "{font-weight: bold;}\n.slds-file-selector__dropzone" + shadowSelector + "{width: 100px;height: 100px;}\n";
    }
    ...
    if (_implicitStylesheets$6) {
      tmpl$a.stylesheets.push.apply(tmpl$a.stylesheets, _implicitStylesheets$6);
    }
    ...
    class LightningColorPickerPanel extends lwc.LightningElement {
      ...
      handleTabChange(event) {
        ...
        this._isCustomTabActive = tabElement.title !== i18n$4.defaultTab;
      }
    ...
    if (_implicitStylesheets$7) {
      tmpl$h.stylesheets.push.apply(tmpl$h.stylesheets, _implicitStylesheets$7);
    }
    ...
    */
    ...
    class LightningTimePicker extends lwc.LightningElement {
      ...
      get messageWhenBadInput() {
        return this._messageWhenBadInput || this.formatString(i18n$9.invalidDate, this.timeFormat);
      }
      ...
      get messageWhenRangeOverflow() {
        ...
        return this._messageWhenRangeOverflow || this.formatString(i18n$9.rangeOverflow, normalizeISOTime(this.max, this.timeFormat).isoValue);
      }
      ...
      get messageWhenRangeUnderflow() {
        return this._messageWhenRangeUnderflow || this.formatString(i18n$9.rangeUnderflow, normalizeISOTime(this.min, this.timeFormat).isoValue);
      }
    ...
    class LightningDateTimePicker extends lwc.LightningElement {
      ...
      get messageWhenRangeOverflow() {
        return this._messageWhenRangeOverflow || this.formatString(i18n$a.rangeOverflow, this.formattedMax);
      }
      ...
      get messageWhenRangeUnderflow() {
        return this._messageWhenRangeUnderflow || this.formatString(i18n$a.rangeUnderflow, this.formattedMin);
      }
    ...
    if (_implicitStylesheets$5) {
      tmpl$l.stylesheets.push.apply(tmpl$l.stylesheets, _implicitStylesheets$5);
    }
    ...
    * */
    ...
    if (_implicitStylesheets$8) {
      tmpl$m.stylesheets.push.apply(tmpl$m.stylesheets, _implicitStylesheets$8);
    }
    ...
    tmpl$n.stylesheetTokens = {
      hostAttribute: "lightning-fileUpload_fileUpload-host",
      shadowAttribute: "lightning-fileUpload_fileUpload"
    };
    ...
    class LightningFileUpload extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.name = void 0;
        this.label = void 0;
      ...
      set recordId(value) {
        ...
        if (!this.isValidRecordId(value)) {
          // eslint-disable-next-line no-console
          console.warn(`<lightning-file-upload> The recordId attribute value is missing or invalid.`);
        }
      }
      ...
      upload(files) {
        ...
        aura.createComponent('forceContent:fileUploadAction', {
    ...
    lwc.registerDecorators(LightningFileUpload, {
      publicProps: {
        name: {
          config: 0
        },
    ...
    var _lightningFileUpload = lwc.registerComponent(LightningFileUpload, {
      tmpl: _tmpl$m
    });
    ...
    function tmpl$o($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        key: 3
      }, [api_text("Ask Accounting Ticket")]), api_element("div", {
        classMap: {
          "slds-form": true,
          "slds-form_stacked": true,
          "slds-form_horizontal": true,
        ...
        key: 7
      }, [api_dynamic($cmp.tickettypelabel)]), api_element("br", {
        key: 8
      }, []), api_element("div", {
        classMap: {
          "slds-grid": true,
        ...
        classMap: {
          "slds-col": true,
          "slds-grid": true,
          "slds-size_5-of-5": true
        },
        key: 10
      }, [api_element("div", {
        classMap: {
          "slds-col": true,
          "slds-size_2-of-5": true
        },
        key: 11
      }, [api_element("label", {
        classMap: {
        ...
        key: 12
      }, [api_text("Account Type")]), api_element("abbr", {
        classMap: {
          "slds-required": true
        },
        attrs: {
        ...
        props: {
          "name": "accounttype",
          "value": $cmp.accounttypevalue,
          "placeholder": "None",
          "options": $cmp.accounttypeoptions
        },
        key: 15,
        on: {
          "change": _m0 || ($ctx._m0 = api_bind($cmp.acccounttypedropdownHandler))
        }
      }, [])])])]), api_element("div", {
        classMap: {
          "slds-grid": true,
        ...
        key: 19
      }, [api_text("Urgent?")])]), api_element("div", {
        classMap: {
          "slds-col": true,
          "slds-size--2-of-5": true
        },
        ...
        key: 21,
        on: {
          "change": _m1 || ($ctx._m1 = api_bind($cmp.urgenthandler))
        }
      }, [])])])]), api_element("div", {
        classMap: {
          "slds-grid": true,
        ...
        key: 25
      }, [api_text("Description")]), api_element("abbr", {
        classMap: {
          "slds-required": true
        },
        attrs: {
        ...
        key: 32
      }, [api_text("Attach Files (Optional)")])]), api_element("div", {
        classMap: {
          "slds-col": true,
          "slds-size--2-of-5": true
        },
        ...
        classMap: {
          "slds-file-selector__dropzone": true
        },
        key: 36
      }, [api_custom_element("lightning-file-upload", _lightningFileUpload, {
        props: {
          "label": "attachment",
          "name": "fileUploader",
          "recordId": $cmp.currentRecordId,
          "multiple": true
        },
        key: 37,
        on: {
          "uploadfinished": _m2 || ($ctx._m2 = api_bind($cmp.uploadfilehandler))
        }
      }, [])])])])])])]), api_element("div", {
        classMap: {
          "slds-text-align--center": true
        ...
        key: 39,
        on: {
          "click": _m3 || ($ctx._m3 = api_bind($cmp.nextHandler))
        }
      }, [api_text("Back")]), api_element("button", {
        classMap: {
          "slds-button": true,
          "slds-button_brand": true
        },
    ...
    var childPage = lwc.registerTemplate(tmpl$o);
    tmpl$o.stylesheets = [];

    if (_implicitStylesheets$4) {
      tmpl$o.stylesheets.push.apply(tmpl$o.stylesheets, _implicitStylesheets$4);
    }
    tmpl$o.stylesheetTokens = {
      hostAttribute: "lwc-testgeneralsupportticket_testgeneralsupportticketsub-host",
      shadowAttribute: "lwc-testgeneralsupportticket_testgeneralsupportticketsub"
    };
    ...
    class App extends lwc.LightningElement {
      constructor(...args) {
        ...
        this.aatlogo = AAT_LOGO;
        this.parentPage = true;
        this.tickettypevalue = void 0;
        this.tickettypelabel = void 0;
        this.accounttypevalue = void 0;
        this.ticketurgent = false;
        this.currentRecordId = void 0;
      }
      ...
      get tickettypeoptions() {
        return [{
          ...
          label: 'Contact Pro/Payment',
          value: 'ContactProPayment'
        }, {
          label: 'Contact Pro/Billing Questions',
          value: 'ContactProBillingQuestions'
        }, {
          label: 'Bad Debt Owed',
          value: 'BadDebtOwed'
        }, {
          ...
          label: 'Credit/Make Good Request',
          value: 'CreditMakeGoodRequest'
        }, {
          label: 'W9 Request',
          value: 'W9Request'
        }, {
          label: 'Vendor Form Request',
          value: 'VendorFormRequest'
        }, {
          label: 'Contract Cancellation',
          value: 'ContractCancellation'
        }, {
          label: 'Recontracting Questions',
          value: 'RecontractingQuestions'
        }, {
          label: 'CA-ETM Questions',
          value: 'CAETMQuestions'
        }, {
          label: 'Other',
          value: 'Other'
        }];
      ...
      get accounttypeoptions() {
        return [{
          ...
          label: 'Legacy TK Account',
          value: 'LegacyTKAccount'
        }, {
          label: 'Legacy WW Account',
          value: 'LegacyWWAccount'
        }];
      }
      ...
      render() {
        return this.parentPage ? _tmpl$8 : childPage;
      }
    ...
    var testgeneralsupportticket = lwc.registerComponent(App, {
      tmpl: _tmpl$8
    });

    return testgeneralsupportticket;
